    ...
    >
        ...
        <div class="grow">
            <div class="relative rounded-md shadow-sm">
                ...
                <input type="email" name="email" id="bd-email" required={true} class="block bg-neutral-300/75 dark:text-white dark:bg-neutral-800 transition-all w-full rounded-md border-0 py-1.5 pl-10 text-neutral-900 ring-1 ring-inset ring-neutral-300 dark:ring-neutral-600  sm:text-sm sm:leading-6" placeholder="you@example.com">
            </div>
        </div>
