...
>
	<!-- moon icon -->
	<svg class="h-5 w-5 text-white" class:hidden={!dark} viewBox="0 0 20 20" fill="currentColor">
		<path d="M17.293 13.293A8 8 0 016.707 2.707a8.001 8.001 0 1010.586 10.586z" />
	</svg>
	<!-- sun icon -->
	<svg class="h-5 w- text-gray-800" class:hidden={dark} viewBox="0 0 20 20" fill="currentColor">
		<path
			fill-rule="evenodd"
